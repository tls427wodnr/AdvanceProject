...
public final class HistoryRepository: HistoryRepositoryProtocol {
    ...
    public func recordHistory(isbn: String, title: String, authors: [String], price: Int, contents: String, thumbnail: String) {
    ...
    public func fetchHistories() -> [(isbn: String, title: String, authors: [String], price: Int, contents: String, thumbnail: String, timestamp: Date)] {
    ...
    public func isHistoryExist(isbn: String) -> Bool {
        let fetchRequest: NSFetchRequest<HistoryEntity> = HistoryEntity.fetchRequest()
    ...
    public func updateHistory(isbn: String) {
        let fetchRequest: NSFetchRequest<HistoryEntity> = HistoryEntity.fetchRequest()
        fetchRequest.predicate = NSPredicate(format: "isbn == %@", isbn)

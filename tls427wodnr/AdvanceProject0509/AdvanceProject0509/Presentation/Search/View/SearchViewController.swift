...
final class SearchViewController: UIViewController {
    ...
    private lazy var dataSource = RxCollectionViewSectionedReloadDataSource<BookSection>(
        ...
        configureSupplementaryView: { dataSource, collectionView, kind, indexPath in
            ...
            case .recent: header.setTitle("최근 본 책")
            case .search: header.setTitle("검색 결과")
            }
            return header
        }
    )
    ...
    private func createRecentBooksSectionLayout() -> NSCollectionLayoutSection {
        ...
        let groupSize = NSCollectionLayoutSize(widthDimension: .estimated(300), heightDimension: .absolute(60))
